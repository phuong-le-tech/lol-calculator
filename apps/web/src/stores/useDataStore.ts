...
import type { Champion, Item, RuneTree, StatShard, Rune, SummonerSpell } from "@lol-sim/types";
...
export const useDataStore = create<DataStore>((set, get) => ({
  ...
  setSummonerSpells: (spells) => set({ summonerSpells: spells }),
  ...
  getSummonerSpell: (id) => get().summonerSpells.find((s) => s.id === id),
}));
